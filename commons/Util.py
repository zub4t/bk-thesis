...
def mean_location_1(subset, current_ts, prev_mean_loc, prev_ts, speed):
    ...
    distance = calculate_distance(prev_mean_loc, {'x': raw_mean_x, 'y': raw_mean_y, 'z': raw_mean_z})
...
def mean_location(subset, current_ts, prev_mean_locs, prev_ts, speed):
    ...
    if distance <= max_distance:
        ...
        mean_loc = move_towards(raw_mean_loc, prev_mean_locs[-1], max_distance / distance)
