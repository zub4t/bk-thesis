...
class Synthetic:
    ...
    def __init__(self):
        pass
    def generate_synthetic_data(self,num_aps,ap_locations={},room_size=(10, 6, 4), time_interval=0.3):
        ...
        for i, person_location in enumerate(Synthetic.real_person_path):
            ...
            for ap_name, ap_location in ap_locations.items():
                ...
                measurement = Measurement(timestamp,ap_name, distance_plus_noise, person_location, ap_location)
    ...
    def generate_random_path(self,num_points, room_size=(10, 6, 4), max_distance=0.2):
        for _ in range(num_points):
            if not Synthetic.real_person_path:  # If person_path is empty, generate the first point
                ...
                while True:
                    ...
                    if calculate_distance(Synthetic.real_person_path[-1], candidate_point) <= max_distance:
    ...
    def square_path(self,num_points, side_length, room_size=(10, 6, 4), height=1.6):
        ...
        for i in range(1, num_points):
            ...
            new_point = next_square_point(Synthetic.real_person_path[-1], side_length / points_per_side, direction)
